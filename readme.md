...
4. Movement hotspot analysis and transition matrices by seasonality (Antonia: Done! The daily patterns look interesting, there are some differences between cities, in particular Istanbul and Tokyo seems to have their own patterns. No seasonal patterns).
